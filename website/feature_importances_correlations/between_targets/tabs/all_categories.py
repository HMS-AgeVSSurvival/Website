            ...
            dcc.Loading(
                [
                    ...
                    dcc.Store(
                        ...
                        data=pd.read_feather("data/all_categories/scores_feature_importances.feather").to_dict(),
                    ),
                    dcc.Store(
                        id="memory_information_feature_importances_correlations_between_targets_all_categories",
                        data=pd.read_feather("data/all_categories/information.feather").to_dict(),
                    ),
                ]
            ),
