...
def get_controls_prediction_performances_feature_importances_all_categories():
    return (
        [get_check_list("targets_prediction_performances_feature_importances_all_categories", TARGETS, "Target:")]
        + [
            get_drop_down(
                f"{main_category}_category_prediction_performances_feature_importances_all_categories",
        ...
        + [
            get_check_list(
                f"algorithm_prediction_performances_feature_importances_all_categories", ALGORITHMS, "Algorithm:"
            ),
            get_item_radio_items(
                "metric_prediction_performances_feature_importances_all_categories",
...
for main_category in MAIN_CATEGORIES:
    ...
    @APP.callback(
        Output(f"{main_category}_category_prediction_performances_feature_importances_all_categories", "value"),
...
@APP.callback(
    [
        Output("metric_prediction_performances_feature_importances_all_categories", "options"),
        Output("metric_prediction_performances_feature_importances_all_categories", "value"),
    ],
    Input(f"targets_prediction_performances_feature_importances_all_categories", "value"),
)
def update_metric_prediction_performances_feature_importances_all_categories(targets):
    if len(targets) > 0:
        return (
...
@APP.callback(
    Output("algorithm_prediction_performances_feature_importances_all_categories", "value"),
    Input(f"algorithm_prediction_performances_feature_importances_all_categories", "value"),
)
def update_algorithms_prediction_performances_feature_importances_all_categories(algorithms):
...
@APP.callback(
    [
        Output("title_train_prediction_performances_feature_importances_all_categories", "children"),
        Output("bars_train_prediction_performances_feature_importances_all_categories", "figure"),
    ],
    [
        Input("memory_prediction_performances_feature_importances_all_categories", "data"),
        Input("memory_information_prediction_performances_feature_importances_all_categories", "data"),
        Input("targets_prediction_performances_feature_importances_all_categories", "value"),
    ]
    + [
        Input(f"{main_category}_category_prediction_performances_feature_importances_all_categories", "value")
        for main_category in MAIN_CATEGORIES
    ...
    + [
        Input(f"algorithm_prediction_performances_feature_importances_all_categories", "value"),
        Input(f"metric_prediction_performances_feature_importances_all_categories", "value"),
    ],
)
def _fill_bars_prediction_performances_feature_importances_all_categories(
    scores_data,
    information_data,
    targets,
...
def get_all_categories():
    return dbc.Container(
        [
            ...
            dbc.Row(
                dbc.Col(
                    dbc.Card(get_controls_prediction_performances_feature_importances_all_categories()),
            ...
            dbc.Col(
                [
                    dcc.Loading(
                        [
                            html.H3(id="title_train_prediction_performances_feature_importances_all_categories"),
                            dcc.Graph(
                                id="bars_train_prediction_performances_feature_importances_all_categories",
