...
for main_category in MAIN_CATEGORIES:
    ...
    def update_categories_prediction_performances_feature_importances_custom_categories(categories):
...
def update_targets_prediction_performances_feature_importances_custom_categories(targets):
