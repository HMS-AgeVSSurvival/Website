...
CUSTOM_CATEGORIES_INDEX = pd.MultiIndex.from_tuples(
    [
        ...
        ("examination", "Dual-Energy__X-ray__Absorptiometry__-__Whole__Body"),
        ...
        ("examination", "Shared__Exclusion__Questions"),
        ...
        ("laboratory", "Metals__-__Urine"),
        ("laboratory", "Non-dioxin-like__Polychlorinated__Biphenyls"),
        ("laboratory", "Parathyroid__Hormone"),
